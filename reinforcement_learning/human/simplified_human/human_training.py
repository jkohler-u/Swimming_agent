...
class HumanSwimmingEnv(MujocoEnv):
    def __init__(self, render_mode=None):
        ...
        # self._model_path = '/home/judith/swimming/Swimming_agent/underwater_swimming_simple_human/human_arms.xml'
        super().__init__(
            self._model_path, 
            frame_skip=5, 
        ...
        obs_size += 3 
        obs_size += 2  # Add 6 for roll, pitch, yaw, distance from watersurface
