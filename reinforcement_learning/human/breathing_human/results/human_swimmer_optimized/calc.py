...
filename = 'human_swimmer_optimized/test_results.csv'
# Average Forward Velocity: -0.0081
# Percentage Head Above Water: 93.90%
# Longest streak of head below water: 31 steps
