...
class HumanSwimmingEnv(MujocoEnv):
    ...
    def _get_obs(self):
        ...
        return np.concatenate([relative_qpos, self.data.qvel, [body_below_surface], [head_above_surface]]).astype(np.float32)
    ...
    def step(self, action):
        ...
        reward = forward_vel * self.forward_reward  **2
        ...
        if  self.max_body_hight_counter > self.leniency:
