...
from reinforcement_learning.worm.breathing_worm.results.worm_human_v12.train_script import HumanSwimmingEnv
...
model = PPO.load("worm_human_v12/ppo_human_swimmer.zip", env=env)
print("Model loaded")
