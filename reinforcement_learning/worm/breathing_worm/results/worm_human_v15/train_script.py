...
class HumanSwimmingEnv(MujocoEnv):
    def __init__(self, render_mode=None, leniency=200, survival_reward=0.01, forward_reward=40, 
                 ...
                 cont_head_reward=5, cont_body_reward=5, cont_body_punishment=1.0, body_punishment=1.0):
    ...
    def step(self, action):
        ...
        if  self.max_body_hight_counter > max(self.leniency * leniency, 50) :
