...
filename = 'results/human_swimmer_increased_survial_no_scaling_incr_forwR_incr_bodyR/test_results.csv'
# Average Forward Velocity: 0.0331
# Percentage Head Above Water: 2.43%
