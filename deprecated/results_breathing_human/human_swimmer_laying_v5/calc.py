...
filename = 'results/human_swimmer_increased_survial_no_scaling/test_results.csv'
# Average Forward Velocity: 0.0550
# Percentage Head Above Water: 89.00%
# Longest streak of head below water: 99 steps
