...
filename = 'results/human_swimmer_no_smothness_reward/test_results.csv'
# Average Forward Velocity: 0.0159
# Percentage Head Above Water: 66.50%
# Longest streak of head below water: 72 steps
