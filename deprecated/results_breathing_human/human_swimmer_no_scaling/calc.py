...
filename = 'results/human_swimmer_no_scaling/test_results.csv'
# Average Forward Velocity: 0.0738
# Percentage Head Above Water: 98.40%
# Longest streak of head below water: 16 steps
