...
filename = 'results/human_swimmer_increased_survial_no_scaling_lower_leniency_slight_incr_bodyP_high_velP/test_results.csv'
# Average Forward Velocity: -0.0073
# Percentage Head Above Water: 1.95%
