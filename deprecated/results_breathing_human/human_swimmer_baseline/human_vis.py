...
from deprecated.results.human_swimmer_baseline.train_script import HumanSwimmingEnv
...
model = PPO.load("results/human_swimmer_baseline/ppo_human_swimmer.zip", env=env)
print("Model loaded")
