...
filename = 'results/human_swimmer_no_survival/test_results.csv'
# Average Forward Velocity: 0.0421
# Percentage Head Above Water: 88.20%
# Longest streak of head below water: 49 steps
