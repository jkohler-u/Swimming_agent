...
from deprecated.results.human_swimmer_no_survival.train_script import HumanSwimmingEnv
...
model = PPO.load("results/human_swimmer_no_survival/ppo_human_swimmer.zip", env=env)
print("Model loaded")
