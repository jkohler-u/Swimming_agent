...
filename = 'results/human_swimmer_increased_survial_no_scaling_lower_leniency/test_results.csv'

# Average Forward Velocity: 0.0283
# Percentage Head Above Water: 5.61%
# Longest streak of head below water: 101 steps
