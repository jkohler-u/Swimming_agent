...
filename = 'results/human_swimmer_increased_survial_no_scaling_higher_cont_body_pun/test_results.csv'
# Average Forward Velocity: 0.0184
# Percentage Head Above Water: 43.67%
